	...
	class KANG_Controller extends CI_Controller
	{
		...
		function render_html($element = 'no_part', $param = array(), $display = "back" )
		{
			...
			* variabel yang berfungsi untuk menampung string js, css, jsi, dan cssi dari config/kang_baseon.php
			...
			/*
			* variabel untuk menentukan apakah itu backend atau frontend
			 */
			...
			* variabel untuk mengecek apakah $element terdefinisi atau tidak
			...
			/*
			* variabel untuk mengecek apakah (title, author dan description) didefinisikan, jika ketiga diantara variabel itu ada yang tidak terdefinisi maka akan otomatis mengambil dari config/kang_baseon.php
			 */
			...
			* CSSI merupakan akronim dari css include.
			...
			/*
			* variabel ini berfungsi untuk mengecek apakah js, css, jsi, dan cssi di definisikan dalam array. Jika true maka data array akan di hitung, tapi jika false maka nilai akan di set 0 (nol).
			 */
