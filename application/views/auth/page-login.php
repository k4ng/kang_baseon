    ...
    <div class="wrapper-page">
    	...
    	<div class="m-t-40 card-box">
            <div class="text-center">
                ...
                <?php
                    if($this->session->flashdata('fail_m')){
                        echo '<h5 class="font-bold m-b-0" style="color: red;">'.$this->session->flashdata('fail_m').'</h5>';
                    }

                    if($this->session->flashdata('succ_m')){
                        echo '<h5 class="font-bold m-b-0" style="color: green;">'.$this->session->flashdata('succ_m').'</h5>';
                    }
                ?>
            </div>
